                       ...
                       <?php 
                        ...
                        <?php endif; ?>
                            <div class="form-group">
                               ...
                               <input type="text" name="username" id="username" class="form-control rounded-0" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,10}" title="Must be a mix of Alpha-Numeric characters and at least 8 to 10 characters" maxlength="10" minlength="8"value="<?= isset($_POST['username']) ? $_POST['username'] : '' ?>" autofocus required>
                            </div>
                            <div class="form-group">
                               <label for="firstname" class="label-control">First Name</label>
                               <input type="text" name="firstname" id="firstname" class="form-control rounded-0" value="<?= isset($_POST['firstname']) ? $_POST['firstname'] : '' ?>" required>
                            </div>
                            <div class="form-group">
                           ...
                           <div class="form-group">
                               ...
                               <input type="password" name="password" id="password" class="form-control rounded-0"pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{10,15}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 10 to 15 characters" maxlength="15" minlength="10" value="<?= isset($_POST['password']) ? $_POST['password'] : '' ?>" required>
                            </div>
            
                            <div class="clear-fix mb-4"></div>
                            <div class="form-group text-end">
                               <a class="btn btn-success" href="login.php">Existing user?</a>
